...
def call_llm_api(api_key, model_name, system_prompt_template, user_prompt_template, temperature) -> Optional[
    str]:
    ...
    while True:
        try:
            ...
            answer = response.json()  # return the response in json format (a dict)
